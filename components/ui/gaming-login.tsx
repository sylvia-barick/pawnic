...
import { Eye, EyeOff, Mail, Lock, Globe, Send, Gamepad2 } from 'lucide-react';
...
export const SocialButton: React.FC<SocialButtonProps> = ({ icon }) => {
    return (
        ...
        <div className="p-8 rounded-2xl backdrop-blur-sm bg-black/50 border border-white/10">
            ...
            <div className="mt-8">
                ...
                <div className="mt-6 grid grid-cols-3 gap-3">
                    <SocialButton icon={<Globe size={18} />} name="Chrome" />
                    <SocialButton icon={<Send size={18} />} name="X" />
